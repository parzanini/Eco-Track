...
<!--      overlay-->
<div v-show="isLoading" class="flex flex-col align-items-middle">
  <div class="fixed inset-0 bg-black bg-opacity-10 z-50"></div>
<!--  loading message-->
  <div v-show="isLoading" class="flex mt-12 w-20 mx-auto z-[90]">
    <svg aria-hidden="true" class="ml-4 w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-green-600"
    ...
    <p class="sr-only">Loading...</p>
      ...
      <button
        type="submit"
        class="px-16 pt-3.5 pb-7 mt-8 max-w-full text-3xl font-extrabold text-black rounded-xl border border-solid bg-green-600 bg-opacity-30 border-green-600 border-opacity-30 w-[294px] max-md:px-5 hover:bg-green-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-green-600"
      >
        SUBMIT
      </button>
